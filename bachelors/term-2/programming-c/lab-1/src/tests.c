...
void test_strlen(char* str) {
    ...
    printf("Results for string \"%s\":\n", str);
    printf("strlen_std: %zu\n", strlen_std_res);
    printf("strlen_indexing: %zu\n", strlen_indexing_res);
    printf("strlen_pointers: %zu\n", strlen_pointers_res);
    printf("\n");
}

void test_strcpy(char* str) {
    printf("Testing strcpy function.\n");
    printf("Results for string \"%s\":\n", str);
    ...
    printf("strcpy_indexing: \"%s\"\n", strcpy_indexing_res);

    strcpy_pointers(strcpy_pointers_res, str);
    printf("strcpy_pointers: \"%s\"\n", strcpy_pointers_res);
...
void test_strcat(char* destination, char* source) {
    ...
    printf("Resuts for strings \"%s\" and \"%s\"\n", destination, source);
