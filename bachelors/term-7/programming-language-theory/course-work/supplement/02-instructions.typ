...
#figure(
  ...
  table(
    ...
    [3],
    [`OPC $LLHH,X`],
    [операнд — адрес; эффективный адрес = адрес + X с переносом],

    [abs,Y],
    [absolute, Y-indexed],
    [3],
    [`OPC $LLHH,Y`],
    [операнд — адрес; эффективный адрес = адрес + Y с переносом],
    ...
    [3],
    [`OPC ($LLHH)`],
    [операнд — адрес; эффективный адрес — содержимое слова по адресу: C.w(\$HHLL)],

    [X,ind],
    [X-indexed, indirect],
    [3],
    [`OPC ($LL,X)`],
    [операнд — адрес в нулевой странице; эффективный адрес — слово в (LL + X, LL + X + 1) без
      переноса: C.w(\$00LL + X)],
    ...
    [3],
    [`OPC ($LL),Y`],
    [операнд — адрес в нулевой странице; эффективный адрес — слово в (LL, LL + 1) + Y с переносом:
      C.w(\$00LL) + Y],
    ...
    [2],
    [`OPC $LL`],
    [операнд — адрес в нулевой странице (старший байт = 0, адрес = \$00LL)],
