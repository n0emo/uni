# 10. Напишите программу, в которой один поток (процесс) осуществляет чтение
# данных из файла, а три других потока (процесса) осуществляют их запись в файл.
# У каждого потока (процесса) свой файл для записи данных. При этом учтите, что
# файлы, в которые производится запись, не должны содержать в себе один и тот же
# набор данных, то есть прочитанная строка из файла может быть единожды
