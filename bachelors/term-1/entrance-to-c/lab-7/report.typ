...
Разработать информационную технологию, позволяющую последовательно заполнить вектор Р индексами
элементов матрицы S, расположенных над её главной диагональю и имеющих положительные значения.
...
На таблице @table-check жёлтым выделены элементы выше главной диагонали матрицы 10х10, зелёным –
положительные из них. Программа вывела их правильно.
