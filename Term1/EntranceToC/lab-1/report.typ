...
Основание прямой призмы — ромб. Одна из диагоналей призмы равна $L$ и составляет с плоскостью
основания угол, равный $alpha$, а с одной из боковых граней угол, равный $beta$. Найти объем призмы
по формуле:
...
В ходе работы были получены базовые навыки написания алгоритма вычисления функции на языке
программирования C.
