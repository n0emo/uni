...
// user defines
#define указатель_светлый unique_ptr
#define сотвори_светлого make_unique
#define указатель_слабый weak_ptr
#define запереть lock
#define указатель_всеобщий shared_ptr
#define сотвори_всеобщего make_shared

#define свернуть reset

#include <optional>
#define авось optional
